...
class FlashShopper extends Component {
  ...
  render() {
    return (
      ...
      <h2>Flash Shopper</h2>
      <a href="https://github.com/gness1804/grocery-list-redux/tree/master" target="_blank">
