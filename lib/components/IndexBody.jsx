    ...
    return (
      <div>
        <div className="page-upper-section">
          <p>
            I am a front-end software engineer, published author, and educator. Feel free to browse my projects below and to <a href="mailto:gness1804@gmail.com" target="_blank" rel="noopener noreferrer">get in touch</a>.
          </p>
        </div>
          ...
          <Link to="/flashcard-fe">
           ...
           <section id="app-store-icons-container">
             ...
             <a href="https://play.google.com/store/apps/details?id=com.grahamnessler.bookmarker&hl=en" target="_blank" rel="noopener noreferrer">
               <img src="images/google-play-store.png" alt="Google Play Store logo." id="app-store-icon" />
             </a>
           </section>
           <p>
