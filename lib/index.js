...
import WeThePeople from './components/WeThePeople';
import FlashShopperReactNative from './components/FlashShopperReactNative';
import WeathrlyRN from './components/WeathrlyRN';
import Bookmarker from './components/Bookmarker';
import NumberGuesserJava from './components/NumberGuesserJava';
import FlashcardFE from './components/FlashcardFE';
...
render((
  <Router history={hashHistory}>
    <Route path="/" component={Application}>
      ...
      <Route path="/we-the-people" component={WeThePeople} />
      <Route path="/flash-shopper-rn" component={FlashShopperReactNative} />
      <Route path="/weathrly-rn" component={WeathrlyRN} />
      <Route path="/bookmarker" component={Bookmarker} />
      <Route path="/number-guesser-java" component={NumberGuesserJava} />
      <Route path="/flashcard-fe" component={FlashcardFE} />
